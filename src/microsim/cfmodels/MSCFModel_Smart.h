...
/****************************************************************************/
#ifndef MSCFModel_Smart_h
#define MSCFModel_Smart_h
...
// class definitions
// ===========================================================================
/** @class MSCFModel_Smart
 * @brief Smart car-following model, with acceleration decrease and faster start
 * @see MSCFModel
 */
class MSCFModel_Smart : public MSCFModel_KraussOrig1 {
public:
    /** @brief Constructor
     ...
     */
    MSCFModel_Smart(const MSVehicleType* vtype, double accel, double decel,
